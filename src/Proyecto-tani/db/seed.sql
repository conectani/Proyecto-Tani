...
begin
  ...
  values 
    ...
    ('Estimulación Temprana: Primeros Pasos', 'ESTIMULACIÓN', 'Ejercicios de gateo y fortalecimiento muscular para preparar a tu bebé a dar sus primeros pasos de forma segura.', '12 min lectura', 'happy-outline', 'https://lh3.googleusercontent.com/aida-public/AB6AXuAzOSbzmn_xadKosD5dYU5zDT-ykmPIk_S638r5tkE_v_34rXeESoNwxVTa2CM2l4ofSLnyF5RWmn6t3pYotLy3BSaq960ljSfc22ij1PomCIyxfcmFRkrpYO2hgLKqo4cPBNKMHlJZCYdlE3-zV8-vZjn2ScocIuVC6MlCqCe_7aWiyhazJrE5-9bUutEjU3tHYVb_U8qoNpQ3rIpJkeJQthXThyqNcU0teibkejj4vg_aLIrwCgEd8gVBwyqQMU1EgJcBb4GAJGw', 9, 15),
    ('Higiene Bucal del Lactante', 'SALUD', 'Aprende cuándo y cómo empezar a limpiar las encías de tu bebé y cuidar sus primeros dientes de leche.', '5 min lectura', 'medkit-outline', 'https://lh3.googleusercontent.com/aida-public/AB6AXuAzOSbzmn_xadKosD5dYU5zDT-ykmPIk_S638r5tkE_v_34rXeESoNwxVTa2CM2l4ofSLnyF5RWmn6t3pYotLy3BSaq960ljSfc22ij1PomCIyxfcmFRkrpYO2hgLKqo4cPBNKMHlJZCYdlE3-zV8-vZjn2ScocIuVC6MlCqCe_7aWiyhazJrE5-9bUutEjU3tHYVb_U8qoNpQ3rIpJkeJQthXThyqNcU0teibkejj4vg_aLIrwCgEd8gVBwyqQMU1EgJcBb4GAJGw', 4, 12),
    ('Importancia del Sueño Infantil', 'SUEÑO', 'Guía práctica para establecer rutinas de sueño saludables y ayudar a tu bebé a dormir toda la noche.', '8 min lectura', 'moon-outline', 'https://lh3.googleusercontent.com/aida-public/AB6AXuAzOSbzmn_xadKosD5dYU5zDT-ykmPIk_S638r5tkE_v_34rXeESoNwxVTa2CM2l4ofSLnyF5RWmn6t3pYotLy3BSaq960ljSfc22ij1PomCIyxfcmFRkrpYO2hgLKqo4cPBNKMHlJZCYdlE3-zV8-vZjn2ScocIuVC6MlCqCe_7aWiyhazJrE5-9bUutEjU3tHYVb_U8qoNpQ3rIpJkeJQthXThyqNcU0teibkejj4vg_aLIrwCgEd8gVBwyqQMU1EgJcBb4GAJGw', 0, 24),
    ('Papilla de Sangrecita Antianémica', 'RECETA MINSA', 'Receta paso a paso aprobada por el MINSA para combatir la anemia utilizando sangrecita de pollo y puré de zapallo.', '15 min preparación', 'time-outline', 'https://lh3.googleusercontent.com/aida-public/AB6AXuAzOSbzmn_xadKosD5dYU5zDT-ykmPIk_S638r5tkE_v_34rXeESoNwxVTa2CM2l4ofSLnyF5RWmn6t3pYotLy3BSaq960ljSfc22ij1PomCIyxfcmFRkrpYO2hgLKqo4cPBNKMHlJZCYdlE3-zV8-vZjn2ScocIuVC6MlCqCe_7aWiyhazJrE5-9bUutEjU3tHYVb_U8qoNpQ3rIpJkeJQthXThyqNcU0teibkejj4vg_aLIrwCgEd8gVBwyqQMU1EgJcBb4GAJGw', 6, 12),
    ('Señales de Alerta en el Desarrollo', 'CRECIMIENTO', 'Aprende a identificar a tiempo retrasos en la motricidad o el lenguaje en niños menores de 2 años.', '10 min lectura', 'alert-circle-outline', 'https://lh3.googleusercontent.com/aida-public/AB6AXuAzOSbzmn_xadKosD5dYU5zDT-ykmPIk_S638r5tkE_v_34rXeESoNwxVTa2CM2l4ofSLnyF5RWmn6t3pYotLy3BSaq960ljSfc22ij1PomCIyxfcmFRkrpYO2hgLKqo4cPBNKMHlJZCYdlE3-zV8-vZjn2ScocIuVC6MlCqCe_7aWiyhazJrE5-9bUutEjU3tHYVb_U8qoNpQ3rIpJkeJQthXThyqNcU0teibkejj4vg_aLIrwCgEd8gVBwyqQMU1EgJcBb4GAJGw', 0, 24);
  ...
  -- Más hitos de desarrollo estándar
  insert into public.hitos_desarrollo (rango_edad_min, rango_edad_max, rango_titulo, hito_codigo, hito_texto, bento_cognitivo, bento_social)
  values 
    (0, 3, 'Meses 0-3: Adaptación y Apego', 'm1', 'Sigue objetos con la mirada y sonríe espontáneamente', 'Fijación y seguimiento visual', 'Sonrisa social ante estímulos'),
    (0, 3, 'Meses 0-3: Adaptación y Apego', 'm2', 'Sostiene la cabeza por unos momentos al estar boca abajo', 'Control motor cefálico', 'Contacto visual sostenido'),
    (12, 18, 'Meses 12-18: Primeros Pasos', 'm3', 'Camina solo con estabilidad y dice al menos 3 palabras claras', 'Exploración espacial activa', 'Balbuceo imitativo con significado'),
    (12, 18, 'Meses 12-18: Primeros Pasos', 'm4', 'Introduce objetos pequeños en recipientes o apila 2 bloques', 'Coordinación visomotora fina', 'Juego de causa y efecto'),
    (18, 24, 'Meses 18-24: Independencia', 'm5', 'Sube escalones gateando o de pie con apoyo, y reconoce partes del cuerpo', 'Reconocimiento de sí mismo', 'Expresión de deseos con señas o palabras');
